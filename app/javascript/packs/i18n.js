const values = {
  en: {
    ...
    revoke_permissions: 'Unlink your Google account',
    plan: 'Plan',
    ...
    free_plan_price_description: 'per person, per 30 days, when billed monthly',
    free_plan_features: 'Top features:',
    free_plan_characters_per_translation: '250 characters per translation',
    free_plan_characters_per_month: '10,000 characters per 30 days',
    ...
    pro_plan_price_description: 'per person, per 30 days, when billed monthly',
    pro_plan_features: 'Top features:',
    pro_plan_characters_per_translation: '20,000 characters per translation',
    pro_plan_characters_per_month: '100,000 characters per 30 days',
  ...
  ja: {
    ...
    revoke_permissions: 'Googleアカウント連携の解除',
    plan: 'プラン',
    ...
    free_plan_characters_per_month: '10,000文字 / 30日',
    ...
    pro_plan_characters_per_month: '100,000文字 / 30日',
