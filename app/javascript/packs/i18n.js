const values = {
  en: {
    ...
    plan: 'Plan',
    free_plan_description: 'You are using the free version of Deep Translator.',
  ...
  ja: {
    ...
    enter_license_key: '表示されているライセンス キーを<a href="%{url}">設定ページ</a>で入力してください。',
    support: 'サポート',
    privacy_policy: 'プライバシーポリシー',
    terms_of_service: '利用規約',
    plan: 'プラン',
    free_plan_description: '無料版の Deep Translator を利用中です。',
    ...
    pro_plan_characters_per_translation: '無制限の文字数 / 翻訳',
